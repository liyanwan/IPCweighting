...
```{r}
lambda_values = 10^seq(-1, -5, length = 70)
# Lasso
alpha_num= 0
max_interval = 10
proxy = simulation_data(num_obs/2, dist, params, censor_dist, censor_params, time_point, X)

results = cross_validate_lambda(dt, lambda_values, var_name, alpha=alpha_num, time_point, max_intervals = max_interval, proxy_data = proxy)
