...
knitr::purl("~/IPCweighting/IPCW/Binned_ICPW_ClassificationTree.Rmd", output = "~/IPCweighting/IPCW/Binned_ICPW_ClassificationTree.R")
source("~/IPCweighting/IPCW/Binned_ICPW_ClassificationTree.R")
